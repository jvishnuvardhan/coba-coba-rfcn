...
def main():
    ...
    dataset_train.initDB(
        "/home/xineria_kn/label/detection_image_train.json", "/home/xineria_kn/100k/train", 70000)
    dataset_train.prepare()

    # Validation dataset
    dataset_val = DeepDriveDataset()
    dataset_val.initDB(
        "/home/xineria_kn/label/detection_image_val.json", "/home/xineria_kn/100k/val", 10000)
    dataset_val.prepare()
